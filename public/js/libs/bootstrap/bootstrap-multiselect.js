 ...
 */
    ...
    Multiselect.prototype = {
        ...
        templates: {
            button: '<button type="button" class="multiselect dropdown-toggle btn btn-sm btn-primary" data-toggle="dropdown"></button>',
        ...
        getSelected: function() {
            //            console.log(this.options.selectAllValue);
            return $('option[value!="' + this.options.selectAllValue + '"]:selected', this.$select).filter(function() { // default
                //return $('option[value!=""]:selected', this.$select).filter(function() {  // Arghya 
